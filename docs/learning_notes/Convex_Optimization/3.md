...
$$
\begin{aligned}
\frac{\part f}{\part x_i} &= f(x)\frac{\lambda_i e^{-x_i}}{1-e^{-x_i}}, \\
\frac{\part^2 f}{\part x_i \part x_j} &= f(x)\frac{\lambda_i e^{-x_i}}{1-e^{-x_i}}\frac{\lambda_j e^{-x_j}}{1-e^{-x_j}}, \quad i\neq j, \\
\frac{\part^2 f}{\part x_i^2} &= f(x)\left(\frac{(\lambda_i e^{-x_i})^2}{(1-e^{-x_i})^2} - \frac{\lambda_i e^{-x_i}}{(1-e^{-x_i})^2}\right).
\end{aligned}
$$
因此得到Hessian为
$$
